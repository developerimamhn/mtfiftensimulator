...
import numbeingss from './image/Frame 1321318957.png';
                ...
                <div>
                  ...
                  <div  className='flex items-start justify-start flex-col pt-[13px] sm:pt-[14px] md:pt-[15px] lg:pt-[16px] xl:pt-[20px] 2xl:pt-[24px]'>
                    <div className='flex items-start flex-col justify-start'>
                      ...
                      <span>A Smarter Way To </span><span className='unlocyhoua'>Master Forex Trading</span>  
                      </h2>
                      <p className='bitstartp text-[12px] sm:text-[13px] md:text-[14px] lg:text-[15px] xl:text-[16px] 2xl:text-[18px] pt-[13px] sm:pt-[14px] md:pt-[15px] lg:pt-[16px] xl:pt-[20px] 2xl:pt-[24px]  pb-[14px] sm:pb-[15px] md:pb-[16px] lg:pb-[20px] xl:pb-[24px] 2xl:pb-[28px] !text-start '>Step into the world of precise and immersive trading with the MT5 simulator. simulate real market conditions, refine your strategies, and gain confidence without risking real money. Manage trades seamlessly, set SL/TP levels with ease, and replay years of historical data to perfect your edge. </p>
                      <p className='bitstartp text-[12px] sm:text-[13px] md:text-[14px] lg:text-[15px] xl:text-[16px] 2xl:text-[18px] pb-[20px] sm:pb-[24px] md:pb-[32px] lg:pb-[36px] xl:pb-[40px] 2xl:pb-[48px] !text-start '>Stay focused on trading, not the clicks—because practice makes profit.</p>
